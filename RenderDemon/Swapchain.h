...
class Swapchain {
public:
	Swapchain(const VulkanContext& ctx, const vk::raii::SurfaceKHR& surface, SDL_Window* window, const Swapchain* oldSwapchain = nullptr);
...
private:
	void createSwapchain(const VulkanContext& ctx, const vk::raii::SurfaceKHR& surface, SDL_Window* window, const Swapchain* oldSwapchain);
